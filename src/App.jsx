...
// --- 공통 상담 함수: 에러 방지를 위해 컴포넌트 밖으로 배치 ---
...
function App() {
  return (
    <div className="bg-white text-slate-900 overflow-x-hidden selection:bg-blue-600 selection:text-white font-sans">
      ...
      <section className="relative min-h-[90vh] md:min-h-screen flex items-center px-5 overflow-hidden bg-slate-950">
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10 pt-20 md:pt-0">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-4xl text-center md:text-left">
            ...
            <button onClick={openChat} className="w-full md:w-auto group flex items-center justify-center gap-3 text-lg md:text-xl font-black bg-white text-slate-900 px-8 py-4 rounded-xl hover:bg-blue-600 hover:text-white transition-all shadow-2xl">
      ...
      {/* 2. Services Section */}
      <section id="services" className="py-20 md:py-32 px-5 bg-white text-slate-900">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6 text-slate-900">
      ...
      {/* 3. Team Network Section */}
      <section id="team" className="py-20 md:py-32 px-5 bg-slate-50 border-t border-slate-100 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20 items-center text-slate-900">
      ...
      <footer className="py-16 md:py-24 px-5 bg-white border-t border-slate-100">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between gap-12 mb-16 text-slate-900">
